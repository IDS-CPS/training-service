...
def train_ae(self, param):
    preprocessor = DataPreprocessor(param["history_size"], param["target_size"])
    ...
    e_mean, e_std = calculate_error(model, preprocessor.get_train_data(), param["history_size"], param["target_size"])
